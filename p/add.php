...
$statement = "INSERT INTO kelas_peserta VALUES('$bp_peserta','$kelas','$jam','$link','Valid','0','0','Belum Lulus')";
...
if (!mysqli_query($koneksi, $statement)) {
    ...
    echo "<script>alert('Kelas yang anda pilih sudah terdaftar !');window.location.href='addkelas.php';</script>";
}
?>