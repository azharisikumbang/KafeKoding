      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light px-0">
          ...
          <div class="collapse navbar-collapse" id="navbarNav" style="margin-top: 3px">
            <ul class="navbar-nav ml-0 ml-lg-auto align-items-left align-items-lg-center">
              ...
              <li class="nav-item"><a class="nav-link login-register" href="loginRegister.php">Login</a></li>
            </ul>
          </div>
        </nav>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-6 left-hero">
            ...
            <a href="loginRegister.php" class="btn-cta">Daftar Kelas</a>
          </div>
          <!-- right-hero -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 d-flex justify-content-center flex-wrap-reverse align-items-center">
            ...
            >
            <a href="loginRegister.php" class="btn-daftar">Daftar Kelas Sekarang</a>
          </div>
        </div>
      </div>
    </section>
